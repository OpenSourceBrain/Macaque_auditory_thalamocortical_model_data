TITLE Mod file for component: Component(id=hh2_na type=ionChannelHH)
...
NEURON {
    ...
    RANGE gion
    RANGE i__hh2_na : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_forwardRate_rate = 1.2800001 (kHz)   : was: 1280.0 (per_time)
    m_forwardRate_midpoint = -37 (mV)      : was: -0.037 (voltage)
    m_forwardRate_scale = 4 (mV)           : was: 0.004 (voltage)
    m_reverseRate_rate = 1.4000001 (kHz)   : was: 1400.0 (per_time)
    m_reverseRate_midpoint = -10 (mV)      : was: -0.01 (voltage)
    m_reverseRate_scale = -5 (mV)          : was: -0.005 (voltage)
    m_q10Settings_q10Factor = 3            : was: 3.0 (none)
    m_q10Settings_experimentalTemp = 309.15 (K): was: 309.15 (temperature)
    m_q10Settings_TENDEGREES = 10 (K)      : was: 10.0 (temperature)
    h_instances = 1                        : was: 1.0 (none)
    h_forwardRate_rate = 0.128 (kHz)       : was: 128.0 (per_time)
    h_forwardRate_midpoint = -33 (mV)      : was: -0.033 (voltage)
    h_forwardRate_scale = -18 (mV)         : was: -0.018000000000000002 (voltage)
    h_reverseRate_rate = 4 (kHz)           : was: 4000.0 (per_time)
    h_reverseRate_midpoint = -10 (mV)      : was: -0.01 (voltage)
    h_reverseRate_scale = 5 (mV)           : was: 0.005 (voltage)
    h_q10Settings_q10Factor = 3            : was: 3.0 (none)
    h_q10Settings_experimentalTemp = 309.15 (K): was: 309.15 (temperature)
...
BREAKPOINT {
    ...
    ? DerivedVariable is based on path: conductanceScaling[*]/factor, on: Component(id=hh2_na type=ionChannelHH), from conductanceScaling; null
    ? Path not present in component, using factor: 1
    
    conductanceScale = 1 
    
    ? DerivedVariable is based on path: gates[*]/fcond, on: Component(id=hh2_na type=ionChannelHH), from gates; Component(id=m type=gateHHrates)
    ...
    ina = gion * (v - ena)
    i__hh2_na =  -1 * ina : set this variable to the current also - note -1 as channel current convention for LEMS used!
