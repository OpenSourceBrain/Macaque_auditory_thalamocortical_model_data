...
PROCEDURE rates() {
    ...
    m_timeCourse_t = exp(0.0378 *  m_timeCourse_zetam  *  m_timeCourse_gmm  * ( m_timeCourse_V  -  m_timeCourse_vhalfm )) / ( m_timeCourse_a0m  * (1 + exp(0.0378 *  m_timeCourse_zetam  * ( m_timeCourse_V  -  m_timeCourse_vhalfm )))) *  m_timeCourse_TIME_SCALE
    
    m_q10Settings_q10 = m_q10Settings_q10Factor ^((temperature -  m_q10Settings_experimentalTemp )/ m_q10Settings_TENDEGREES )
    ...
    h_reverseRate_r = h_reverseRate_rate  / (1 + exp(0 - (v -  h_reverseRate_midpoint )/ h_reverseRate_scale ))
    h_timeCourse_V = v /  h_timeCourse_VOLT_SCALE
    h_timeCourse_t = exp(0.0378 *  h_timeCourse_zetah  *  h_timeCourse_gmh  * ( h_timeCourse_V  -  h_timeCourse_vhalfh )) / ( h_timeCourse_a0h  * (1 + exp(0.0378 *  h_timeCourse_zetah  * ( h_timeCourse_V  -  h_timeCourse_vhalfh )))) *  h_timeCourse_TIME_SCALE
    
    h_q10Settings_q10 = h_q10Settings_q10Factor ^((temperature -  h_q10Settings_experimentalTemp )/ h_q10Settings_TENDEGREES )
