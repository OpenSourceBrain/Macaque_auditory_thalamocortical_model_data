...
#define m_timeCourse_mmin _p[11]
#define m_timeCourse_mmin_columnindex 11
#define m_timeCourse_a0m _p[12]
#define m_timeCourse_a0m_columnindex 12
#define m_timeCourse_zetam _p[13]
#define m_timeCourse_zetam_columnindex 13
#define m_timeCourse_gmm _p[14]
#define m_timeCourse_gmm_columnindex 14
#define m_timeCourse_vhalfm _p[15]
#define m_timeCourse_vhalfm_columnindex 15
#define m_q10Settings_q10Factor _p[16]
#define m_q10Settings_q10Factor_columnindex 16
#define m_q10Settings_experimentalTemp _p[17]
#define m_q10Settings_experimentalTemp_columnindex 17
#define m_q10Settings_TENDEGREES _p[18]
#define m_q10Settings_TENDEGREES_columnindex 18
#define h_instances _p[19]
#define h_instances_columnindex 19
#define h_forwardRate_rate _p[20]
#define h_forwardRate_rate_columnindex 20
#define h_forwardRate_midpoint _p[21]
#define h_forwardRate_midpoint_columnindex 21
#define h_forwardRate_scale _p[22]
#define h_forwardRate_scale_columnindex 22
#define h_reverseRate_rate _p[23]
#define h_reverseRate_rate_columnindex 23
#define h_reverseRate_midpoint _p[24]
#define h_reverseRate_midpoint_columnindex 24
#define h_reverseRate_scale _p[25]
#define h_reverseRate_scale_columnindex 25
#define h_timeCourse_TIME_SCALE _p[26]
#define h_timeCourse_TIME_SCALE_columnindex 26
#define h_timeCourse_VOLT_SCALE _p[27]
#define h_timeCourse_VOLT_SCALE_columnindex 27
#define h_timeCourse_hmin _p[28]
#define h_timeCourse_hmin_columnindex 28
#define h_timeCourse_a0h _p[29]
#define h_timeCourse_a0h_columnindex 29
#define h_timeCourse_zetah _p[30]
#define h_timeCourse_zetah_columnindex 30
#define h_timeCourse_gmh _p[31]
#define h_timeCourse_gmh_columnindex 31
#define h_timeCourse_vhalfh _p[32]
#define h_timeCourse_vhalfh_columnindex 32
#define h_q10Settings_q10Factor _p[33]
#define h_q10Settings_q10Factor_columnindex 33
#define h_q10Settings_experimentalTemp _p[34]
#define h_q10Settings_experimentalTemp_columnindex 34
#define h_q10Settings_TENDEGREES _p[35]
#define h_q10Settings_TENDEGREES_columnindex 35
#define gion _p[36]
#define gion_columnindex 36
#define i__cat _p[37]
#define i__cat_columnindex 37
#define m_forwardRate_x _p[38]
#define m_forwardRate_x_columnindex 38
#define m_forwardRate_r _p[39]
#define m_forwardRate_r_columnindex 39
#define m_reverseRate_r _p[40]
#define m_reverseRate_r_columnindex 40
#define m_timeCourse_V _p[41]
#define m_timeCourse_V_columnindex 41
#define m_timeCourse_t _p[42]
#define m_timeCourse_t_columnindex 42
#define m_q10Settings_q10 _p[43]
#define m_q10Settings_q10_columnindex 43
#define m_rateScale _p[44]
#define m_rateScale_columnindex 44
#define m_alpha _p[45]
#define m_alpha_columnindex 45
#define m_beta _p[46]
#define m_beta_columnindex 46
#define m_fcond _p[47]
#define m_fcond_columnindex 47
#define m_inf _p[48]
#define m_inf_columnindex 48
#define m_tauUnscaled _p[49]
#define m_tauUnscaled_columnindex 49
#define m_tau _p[50]
#define m_tau_columnindex 50
#define h_forwardRate_r _p[51]
#define h_forwardRate_r_columnindex 51
#define h_reverseRate_r _p[52]
#define h_reverseRate_r_columnindex 52
#define h_timeCourse_V _p[53]
#define h_timeCourse_V_columnindex 53
#define h_timeCourse_t _p[54]
#define h_timeCourse_t_columnindex 54
#define h_q10Settings_q10 _p[55]
#define h_q10Settings_q10_columnindex 55
#define h_rateScale _p[56]
#define h_rateScale_columnindex 56
#define h_alpha _p[57]
#define h_alpha_columnindex 57
#define h_beta _p[58]
#define h_beta_columnindex 58
#define h_fcond _p[59]
#define h_fcond_columnindex 59
#define h_inf _p[60]
#define h_inf_columnindex 60
#define h_tauUnscaled _p[61]
#define h_tauUnscaled_columnindex 61
#define h_tau _p[62]
#define h_tau_columnindex 62
#define conductanceScale _p[63]
#define conductanceScale_columnindex 63
#define fopen0 _p[64]
#define fopen0_columnindex 64
#define fopen _p[65]
#define fopen_columnindex 65
#define g _p[66]
#define g_columnindex 66
#define m_q _p[67]
#define m_q_columnindex 67
#define h_q _p[68]
#define h_q_columnindex 68
#define temperature _p[69]
#define temperature_columnindex 69
#define eca _p[70]
#define eca_columnindex 70
#define ica _p[71]
#define ica_columnindex 71
#define rate_m_q _p[72]
#define rate_m_q_columnindex 72
#define rate_h_q _p[73]
#define rate_h_q_columnindex 73
#define Dm_q _p[74]
#define Dm_q_columnindex 74
#define Dh_q _p[75]
#define Dh_q_columnindex 75
#define v _p[76]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "gmax_cat", "S/cm2",
 "conductance_cat", "uS",
 "m_forwardRate_rate_cat", "kHz",
 "m_forwardRate_midpoint_cat", "mV",
 "m_forwardRate_scale_cat", "mV",
 "m_reverseRate_rate_cat", "kHz",
 "m_reverseRate_midpoint_cat", "mV",
 "m_reverseRate_scale_cat", "mV",
 "m_timeCourse_TIME_SCALE_cat", "ms",
 "m_timeCourse_VOLT_SCALE_cat", "mV",
 "m_timeCourse_mmin_cat", "ms",
 "m_q10Settings_experimentalTemp_cat", "K",
 "m_q10Settings_TENDEGREES_cat", "K",
 "h_forwardRate_rate_cat", "kHz",
 "h_forwardRate_midpoint_cat", "mV",
 "h_forwardRate_scale_cat", "mV",
 "h_reverseRate_rate_cat", "kHz",
 "h_reverseRate_midpoint_cat", "mV",
 "h_reverseRate_scale_cat", "mV",
 "h_timeCourse_TIME_SCALE_cat", "ms",
 "h_timeCourse_VOLT_SCALE_cat", "mV",
 "h_timeCourse_hmin_cat", "ms",
 "h_q10Settings_experimentalTemp_cat", "K",
 "h_q10Settings_TENDEGREES_cat", "K",
 "gion_cat", "S/cm2",
 "i__cat_cat", "mA/cm2",
 "m_forwardRate_r_cat", "kHz",
 "m_reverseRate_r_cat", "kHz",
 "m_timeCourse_t_cat", "ms",
 "m_alpha_cat", "kHz",
 "m_beta_cat", "kHz",
 "m_tauUnscaled_cat", "ms",
 "m_tau_cat", "ms",
 "h_forwardRate_r_cat", "kHz",
 "h_reverseRate_r_cat", "kHz",
 "h_timeCourse_t_cat", "ms",
 "h_alpha_cat", "kHz",
 "h_beta_cat", "kHz",
 "h_tauUnscaled_cat", "ms",
 "h_tau_cat", "ms",
 "g_cat", "uS",
 0,0
};
...
"cat",
 ...
 "conductance_cat",
 "m_instances_cat",
 "m_forwardRate_rate_cat",
 "m_forwardRate_midpoint_cat",
 "m_forwardRate_scale_cat",
 "m_reverseRate_rate_cat",
 "m_reverseRate_midpoint_cat",
 "m_reverseRate_scale_cat",
 "m_timeCourse_TIME_SCALE_cat",
 "m_timeCourse_VOLT_SCALE_cat",
 "m_timeCourse_mmin_cat",
 "m_timeCourse_a0m_cat",
 "m_timeCourse_zetam_cat",
 "m_timeCourse_gmm_cat",
 "m_timeCourse_vhalfm_cat",
 "m_q10Settings_q10Factor_cat",
 "m_q10Settings_experimentalTemp_cat",
 "m_q10Settings_TENDEGREES_cat",
 "h_instances_cat",
 "h_forwardRate_rate_cat",
 "h_forwardRate_midpoint_cat",
 "h_forwardRate_scale_cat",
 "h_reverseRate_rate_cat",
 "h_reverseRate_midpoint_cat",
 "h_reverseRate_scale_cat",
 "h_timeCourse_TIME_SCALE_cat",
 "h_timeCourse_VOLT_SCALE_cat",
 "h_timeCourse_hmin_cat",
 "h_timeCourse_a0h_cat",
 "h_timeCourse_zetah_cat",
 "h_timeCourse_gmh_cat",
 "h_timeCourse_vhalfh_cat",
 "h_q10Settings_q10Factor_cat",
 "h_q10Settings_experimentalTemp_cat",
 "h_q10Settings_TENDEGREES_cat",
 0,
 "gion_cat",
 "i__cat_cat",
 "m_forwardRate_x_cat",
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	conductance = 1e-05;
 	m_instances = 2;
 	m_forwardRate_rate = 2;
 	m_forwardRate_midpoint = 19.26;
 	m_forwardRate_scale = 10;
 	m_reverseRate_rate = 0.009;
 	m_reverseRate_midpoint = 0;
 	m_reverseRate_scale = -22.03;
 	m_timeCourse_TIME_SCALE = 1;
 	m_timeCourse_VOLT_SCALE = 1;
 	m_timeCourse_mmin = 0.2;
 	m_timeCourse_a0m = 0.04;
 	m_timeCourse_zetam = 2;
 	m_timeCourse_gmm = 0.1;
 	m_timeCourse_vhalfm = -28;
 	m_q10Settings_q10Factor = 5;
 	m_q10Settings_experimentalTemp = 298.15;
 	m_q10Settings_TENDEGREES = 10;
 	h_instances = 1;
 	h_forwardRate_rate = 1e-06;
 	h_forwardRate_midpoint = 0;
 	h_forwardRate_scale = -16.26;
 	h_reverseRate_rate = 1;
 	h_reverseRate_midpoint = 29.79;
 	h_reverseRate_scale = 10;
 	h_timeCourse_TIME_SCALE = 1;
 	h_timeCourse_VOLT_SCALE = 1;
 	h_timeCourse_hmin = 10;
 	h_timeCourse_a0h = 0.015;
 	h_timeCourse_zetah = 3.5;
 	h_timeCourse_gmh = 0.6;
 	h_timeCourse_vhalfh = -75;
 	h_q10Settings_q10Factor = 5;
 	h_q10Settings_experimentalTemp = 298.15;
...
static int _reset;
static char *modelname = "Mod file for component: Component(id=cat type=ionChannelHH)";
...
static int  rates ( _threadargsproto_ ) {
   ...
   if ( exp ( 0.0378 * h_timeCourse_zetah * h_timeCourse_gmh * ( h_timeCourse_V - h_timeCourse_vhalfh ) ) / ( h_timeCourse_a0h * ( 1.0 + exp ( 0.0378 * h_timeCourse_zetah * ( h_timeCourse_V - h_timeCourse_vhalfh ) ) ) ) * h_timeCourse_TIME_SCALE < h_timeCourse_hmin ) {
     h_timeCourse_t = h_timeCourse_hmin ;
     }
   else {
     h_timeCourse_t = exp ( 0.0378 * h_timeCourse_zetah * h_timeCourse_gmh * ( h_timeCourse_V - h_timeCourse_vhalfh ) ) / ( h_timeCourse_a0h * ( 1.0 + exp ( 0.0378 * h_timeCourse_zetah * ( h_timeCourse_V - h_timeCourse_vhalfh ) ) ) ) * h_timeCourse_TIME_SCALE ;
     }
...
static const char* nmodl_file_text = 
  ...
  "    RANGE h_timeCourse_a0h                  : parameter\n"
  "    RANGE h_timeCourse_zetah                : parameter\n"
  "    RANGE h_timeCourse_gmh                  : parameter\n"
  "    RANGE h_timeCourse_vhalfh               : parameter\n"
  ...
  "    m_reverseRate_rate = 0.009000001 (kHz) : was: 9.0 (per_time)\n"
  "    m_reverseRate_midpoint = 0 (mV)        : was: 0.0 (voltage)\n"
  "    m_reverseRate_scale = -22.03 (mV)      : was: -0.02203 (voltage)\n"
  ...
  "    m_timeCourse_a0m = 0.04                : was: 0.04 (none)\n"
  "    m_timeCourse_zetam = 2                 : was: 2.0 (none)\n"
  "    m_timeCourse_gmm = 0.1                 : was: 0.1 (none)\n"
  "    m_timeCourse_vhalfm = -28              : was: -28.0 (none)\n"
  ...
  "    h_forwardRate_rate = 1.0E-6 (kHz)      : was: 0.001 (per_time)\n"
  "    h_forwardRate_midpoint = 0 (mV)        : was: 0.0 (voltage)\n"
  "    h_forwardRate_scale = -16.26 (mV)      : was: -0.016260000000000004 (voltage)\n"
  "    h_reverseRate_rate = 1 (kHz)           : was: 1000.0 (per_time)\n"
  "    h_reverseRate_midpoint = 29.79 (mV)    : was: 0.02979 (voltage)\n"
  ...
  "    h_timeCourse_hmin = 10 (ms)            : was: 0.01 (time)\n"
  "    h_timeCourse_a0h = 0.015               : was: 0.015 (none)\n"
  "    h_timeCourse_zetah = 3.5               : was: 3.5 (none)\n"
  "    h_timeCourse_gmh = 0.6                 : was: 0.6 (none)\n"
  "    h_timeCourse_vhalfh = -75              : was: -75.0 (none)\n"
  "    h_q10Settings_q10Factor = 5            : was: 5.0 (none)\n"
  ...
  "    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=m type=gateHHratesTau), from timeCourse; Component(id=null type=cat_m_tau)\n"
  ...
  "    if (exp(0.0378 *  h_timeCourse_zetah  *  h_timeCourse_gmh  * ( h_timeCourse_V  -  h_timeCourse_vhalfh )) / ( h_timeCourse_a0h  * (1 + exp(0.0378 *  h_timeCourse_zetah  * ( h_timeCourse_V  -  h_timeCourse_vhalfh )))) *  h_timeCourse_TIME_SCALE  <  h_timeCourse_hmin)  { \n"
  "        h_timeCourse_t = h_timeCourse_hmin ? evaluable cdv\n"
  "    } else  { \n"
  "        h_timeCourse_t = exp(0.0378 *  h_timeCourse_zetah  *  h_timeCourse_gmh  * ( h_timeCourse_V  -  h_timeCourse_vhalfh )) / ( h_timeCourse_a0h  * (1 + exp(0.0378 *  h_timeCourse_zetah  * ( h_timeCourse_V  -  h_timeCourse_vhalfh )))) *  h_timeCourse_TIME_SCALE ? evaluable cdv\n"
  "    }\n"
  "    \n"
  ...
  "    ? DerivedVariable is based on path: timeCourse/t, on: Component(id=h type=gateHHratesTau), from timeCourse; Component(id=null type=cat_h_tau)\n"
