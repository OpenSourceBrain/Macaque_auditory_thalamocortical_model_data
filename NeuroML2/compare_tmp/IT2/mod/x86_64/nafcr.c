...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nafcr /home/gluciferd/Macaque_auditory_thalamocortical_model_data/model/mod/nafcr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gluciferd/Macaque_auditory_thalamocortical_model_data/model/mod/nafcr.mod";
static const char* nmodl_file_text = 
  ": Fast Na+ channel\n"
  "\n"
  "NEURON {\n"
