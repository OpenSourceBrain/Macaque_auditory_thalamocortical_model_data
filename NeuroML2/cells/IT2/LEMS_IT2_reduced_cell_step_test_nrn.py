...
Components:
    ...
    pg (Type: pulseGenerator:  delay=0.2 (SI time) duration=1.0 (SI time) amplitude=3.0E-10 (SI current))
    IT2_reduced_cell_net (Type: network)
    IT2_reduced_cell_step_test (Type: Simulation:  length=1.5 (SI time) step=1.0E-5 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt=None, seed=12345, abs_tol=None, rel_tol=None):
        ...
        '''
        Adding simulation Component(id=IT2_reduced_cell_step_test type=Simulation) of network/component: IT2_reduced_cell_net (Type: network)
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=1500.0, dt=0.01, seed=12345, abs_tol=None, rel_tol=None)
